# Property(ConnectionPointsInfo,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~Property(ConnectionPointsInfo,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.ConnectionPointsInfo id, int index);
   void set (Properties.ConnectionPointsInfo id, int index, PropertyValue^ value);
}
```
```
...
*index*
:   Index of the ConnectionPointsInfo's property
