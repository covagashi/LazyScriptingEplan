# CDP_CON_ACL_STYLE Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~CDP_CON_ACL_STYLE().html

---

Associated connections: Line type of autoconnecting line # 31039.
...
```
public:
property PropertyValue^ CDP_CON_ACL_STYLE {
   PropertyValue^ get();
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~CDP_CON_ACL_STYLE.html)