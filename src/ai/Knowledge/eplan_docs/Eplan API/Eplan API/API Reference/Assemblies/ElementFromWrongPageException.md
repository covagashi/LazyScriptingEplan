...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ElementFromWrongPageException.html

---

Throw because group can't insert new element from different page than already added elements.
...
               **Eplan.EplApi.DataModel.ElementFromWrongPageException**
...
```
```
public class ElementFromWrongPageException : InvalidArgumentException
```
```

```
```
public ref class ElementFromWrongPageException : public InvalidArgumentException
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ElementFromWrongPageException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ElementFromWrongPageException~_ctor.html) | Overloaded. |
