...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.RectanglePropertyList~Property(Rectangle).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Rectangle id);
   void set (Properties.Rectangle id, PropertyValue^ value);
}
```
```
