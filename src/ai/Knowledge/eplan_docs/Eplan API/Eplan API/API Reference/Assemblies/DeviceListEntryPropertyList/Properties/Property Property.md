...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceListEntryPropertyList~Property.html
...
| --- | --- |
| [Property(DeviceListEntry,Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceListEntryPropertyList~Property(DeviceListEntry,Int32).html) | Method used by operator[] in order to access indexed properties. |
| [Property(DeviceListEntry)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceListEntryPropertyList~Property(DeviceListEntry).html) | Method used by operator[] in order to access properties. |
| [Property(AnyPropertyId,Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceListEntryPropertyList~Property(AnyPropertyId,Int32).html) | Method used by operator[] in order to access indexed properties by AnyPropertyId. |
| [Property(AnyPropertyId)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceListEntryPropertyList~Property(AnyPropertyId).html) | Method used by operator[] in order to access properties by AnyPropertyId. |
...
[Properties.DeviceListEntry Enumeration](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Properties+DeviceListEntry.html)