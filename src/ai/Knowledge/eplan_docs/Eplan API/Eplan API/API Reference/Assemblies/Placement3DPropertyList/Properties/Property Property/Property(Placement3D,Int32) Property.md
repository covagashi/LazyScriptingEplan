# Property(Placement3D,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~Property(Placement3D,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Placement3D id, int index);
   void set (Properties.Placement3D id, int index, PropertyValue^ value);
}
```
```
...
*index*
:   Index of the Placement3D's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~Property.html)
