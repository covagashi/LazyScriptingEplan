...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeletedObjectInfo.html

---

This class represents deleted object marker in the project where revision was created.
...
            **Eplan.EplApi.DataModel.DeletedObjectInfo**
...
```
```
public class DeletedObjectInfo : SymbolReference, IPropertyPlacementsContainer
```
```

```
```
public ref class DeletedObjectInfo : public SymbolReference, IPropertyPlacementsContainer
```
```
