# Property(PlaceHolder,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PlaceHolderPropertyList~Property(PlaceHolder,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.PlaceHolder id, int index);
   void set (Properties.PlaceHolder id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the PlaceHolder's property

*index*
:   Index of the PlaceHolder's property
