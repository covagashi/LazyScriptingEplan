# Create(Project,FunctionDefinition,List<Placement3D>) Method

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Area~Create(Project,FunctionDefinition,List{Placement3D}).html
