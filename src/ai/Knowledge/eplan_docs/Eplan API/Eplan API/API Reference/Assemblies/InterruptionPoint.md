...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InterruptionPoint.html

---

This class represents interruption point in the project.
...
               **Eplan.EplApi.DataModel.InterruptionPoint**
...
| Public Property | [IsStarSource](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InterruptionPoint~IsStarSource.html) | Gets/sets the Star source property |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InterruptionPoint~Properties.html) | Allows user access to InterruptionPoint properties. |
...
| Public Property | [WriteProtected](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InterruptionPoint~WriteProtected.html) | Check if object is currently write protected or sets Manual write protection |
