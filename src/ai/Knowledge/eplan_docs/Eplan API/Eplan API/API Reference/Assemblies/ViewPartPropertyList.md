...
               **Eplan.EplApi.DataModel.ViewPartPropertyList**
...
public class ViewPartPropertyList : BlockPropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class ViewPartPropertyList : public BlockPropertyList
```
```
...
- [C#](#i-tab-content-c02e30ab-dcb7-443b-b784-8e012f2bf715)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ViewPartPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ViewPartPropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [INSTANCE\_ACTIVE\_PROPERTYSET](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_ACTIVE_PROPERTYSET().html) | Overloaded. Property arrangement # 19307. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
| Public Property | [INSTANCE\_FULLPLACEMENTLOCATION](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_FULLPLACEMENTLOCATION().html) | Overloaded. Placement # 19007. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
| Public Property | [INSTANCE\_PAGEFULLNAME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_PAGEFULLNAME().html) | Overloaded. Page name (full) # 19023. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
| Public Property | [INSTANCE\_PAGENAME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_PAGENAME().html) | Overloaded. Page name # 19022. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
| Public Property | [INSTANCE\_PAGETYPE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_PAGETYPE().html) | Overloaded. Page type # 19020. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
| Public Property | [INSTANCE\_PATHID](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_PATHID().html) | Overloaded. Column number # 19005. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
| Public Property | [INSTANCE\_POSID](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_POSID().html) | Overloaded. Row number # 19006. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
...
| Public Property | [INSTANCE\_TYPE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_TYPE().html) | Overloaded. Representation type / report type # 19021. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
| Public Property | [INSTANCE\_USER\_DEFINED\_PROPERTYSET](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_USER_DEFINED_PROPERTYSET().html) | Overloaded. User-defined property arrangement: Name # 19008. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
| Public Property | [INSTANCE\_XCOORD](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_XCOORD().html) | Overloaded. X coordinate # 19002. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
| Public Property | [INSTANCE\_YCOORD](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~INSTANCE_YCOORD().html) | Overloaded. Y coordinate # 19003. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ViewPartPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties by AnyPropertyId. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of ViewPartPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. (Inherited from [Eplan.EplApi.DataModel.BlockPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.BlockPropertyList.html)) |
