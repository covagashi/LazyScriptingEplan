...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ContextPropertyPlacement~GetBoundingBox().html
...
In order to use function `GetBoundingBox` property [Placement.Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Placement~Page.html) can't be null.
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ContextPropertyPlacement~GetBoundingBox.html)