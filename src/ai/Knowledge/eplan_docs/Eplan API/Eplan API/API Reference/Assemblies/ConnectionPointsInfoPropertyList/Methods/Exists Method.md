...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~Exists.html
...
| --- | --- |
| [Exists(ConnectionPointsInfo)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~Exists(ConnectionPointsInfo).html) | Checks property existence for used obiect. |
