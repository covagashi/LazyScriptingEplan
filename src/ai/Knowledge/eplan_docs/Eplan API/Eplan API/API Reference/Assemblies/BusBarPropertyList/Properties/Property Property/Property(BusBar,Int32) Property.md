# Property(BusBar,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarPropertyList~Property(BusBar,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.BusBar id, int index);
   void set (Properties.BusBar id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the BusBar's property

*index*
:   Index of the BusBar's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarPropertyList~Property.html)
