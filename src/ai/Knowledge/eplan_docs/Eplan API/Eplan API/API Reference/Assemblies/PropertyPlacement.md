...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PropertyPlacement.html
...
| Public Property | [Project](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PropertyPlacement~Project.html) | Overridden. Returns the project to which the StorableObject belongs. |
...
| Public Method | [GetBoundingBox](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PropertyPlacement~GetBoundingBox.html) | Overloaded. PropertyPlacement bounding box. Bounding box is a rectangle which contain this placement. It can be also used to determine placement size. |
