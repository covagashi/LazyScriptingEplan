...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.CommentPropertyList~Property(Comment).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Comment id);
   void set (Properties.Comment id, PropertyValue^ value);
}
```
```
