# Property(Function3D) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Function3DPropertyList~Property(Function3D).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Function3D id);
   void set (Properties.Function3D id, PropertyValue^ value);
}
```
```
