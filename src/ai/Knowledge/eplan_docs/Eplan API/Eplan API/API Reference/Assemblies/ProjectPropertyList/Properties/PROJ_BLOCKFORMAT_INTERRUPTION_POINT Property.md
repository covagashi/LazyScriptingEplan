...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_BLOCKFORMAT_INTERRUPTION_POINT(Int32).html
...
```
public:
property PropertyValue^ PROJ_BLOCKFORMAT_INTERRUPTION_POINT {
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_BLOCKFORMAT_INTERRUPTION_POINT.html)