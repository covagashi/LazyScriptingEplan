# PROJ_ENDCUSTOMERCOUNTRY Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_ENDCUSTOMERCOUNTRY().html

---

End customer: Country # 10139.
...
```
public:
property PropertyValue^ PROJ_ENDCUSTOMERCOUNTRY {
   PropertyValue^ get();
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_ENDCUSTOMERCOUNTRY.html)