...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Duct.html

---

Represents 3D object of cable duct in P8.
...
               **Eplan.EplApi.DataModel.E3D.Duct**
...
| Public Property | [Length](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Duct~Length.html) | Overridden. Returns and sets length of this object. Length is stored in mm. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Duct~Properties.html) | .NET Property enabling access to EPLAN properties of the Duct object. |
...
| Public Methodstatic (Shared in Visual Basic) | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Duct~Create.html) | Overloaded. Creates not placed Duct object with given length. |
| Public Methodstatic (Shared in Visual Basic) | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Duct~CreateTransient.html) | Overloaded. Creates transient and not placed Duct object with given length. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of Duct object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
