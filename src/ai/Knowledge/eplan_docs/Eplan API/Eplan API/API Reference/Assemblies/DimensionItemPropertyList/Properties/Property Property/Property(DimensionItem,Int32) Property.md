# Property(DimensionItem,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionItemPropertyList~Property(DimensionItem,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.DimensionItem id, int index);
   void set (Properties.DimensionItem id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the DimensionItem's property

*index*
:   Index of the DimensionItem's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionItemPropertyList~Property.html)
