# Property(ConnectionDefinitionPoint) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/topic133.html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.ConnectionDefinitionPoint id);
   void set (Properties.ConnectionDefinitionPoint id, PropertyValue^ value);
}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~Property.html)
