# Property(BusBar) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarPropertyList~Property(BusBar).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.BusBar id);
   void set (Properties.BusBar id, PropertyValue^ value);
}
```
```
