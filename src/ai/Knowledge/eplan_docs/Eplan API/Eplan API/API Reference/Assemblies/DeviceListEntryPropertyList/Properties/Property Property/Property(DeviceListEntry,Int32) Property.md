# Property(DeviceListEntry,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceListEntryPropertyList~Property(DeviceListEntry,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.DeviceListEntry id, int index);
   void set (Properties.DeviceListEntry id, int index, PropertyValue^ value);
}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceListEntryPropertyList~Property.html)
