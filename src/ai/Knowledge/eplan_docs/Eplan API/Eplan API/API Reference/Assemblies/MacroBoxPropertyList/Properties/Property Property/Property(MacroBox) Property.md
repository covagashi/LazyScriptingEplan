# Property(MacroBox) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroBoxPropertyList~Property(MacroBox).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.MacroBox id);
   void set (Properties.MacroBox id, PropertyValue^ value);
}
```
```
