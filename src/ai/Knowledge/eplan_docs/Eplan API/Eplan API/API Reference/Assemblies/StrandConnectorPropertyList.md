...
               **Eplan.EplApi.DataModel.StrandConnectorPropertyList**
...
public class StrandConnectorPropertyList : SymbolReferencePropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class StrandConnectorPropertyList : public SymbolReferencePropertyList
```
```
...
- [C#](#i-tab-content-339cc135-a270-477b-a0b3-5dab385fcded)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [StrandConnectorPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandConnectorPropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandConnectorPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties. |
...
| Public Property | [STRANDCONNECTOR\_DATA\_AUTOMATIC](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandConnectorPropertyList~STRANDCONNECTOR_DATA_AUTOMATIC().html) | Bundle: Connection point data # 19072. |
| Public Property | [STRANDCONNECTOR\_DESCRIPTION](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandConnectorPropertyList~STRANDCONNECTOR_DESCRIPTION().html) | Bundle: Connection point description # 19071. |
| Public Property | [STRANDCONNECTOR\_DESIGNATION](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandConnectorPropertyList~STRANDCONNECTOR_DESIGNATION().html) | Bundle: Connection point designation # 19070. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of StrandConnectorPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandConnectorPropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. |
