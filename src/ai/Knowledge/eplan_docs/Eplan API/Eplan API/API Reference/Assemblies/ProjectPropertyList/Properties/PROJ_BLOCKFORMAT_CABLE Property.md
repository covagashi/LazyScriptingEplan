# PROJ_BLOCKFORMAT_CABLE Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_BLOCKFORMAT_CABLE(Int32).html

---

Block property: Format (cable / shield) # 10607.
...
```
public:
property PropertyValue^ PROJ_BLOCKFORMAT_CABLE {
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_BLOCKFORMAT_CABLE.html)