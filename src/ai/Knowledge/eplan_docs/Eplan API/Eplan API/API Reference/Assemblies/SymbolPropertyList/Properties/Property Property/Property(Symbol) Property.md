...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~Property(Symbol).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Symbol id);
   void set (Properties.Symbol id, PropertyValue^ value);
}
```
```
