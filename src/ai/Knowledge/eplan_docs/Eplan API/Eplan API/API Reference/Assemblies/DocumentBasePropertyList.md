...
public class DocumentBasePropertyList : GroupPropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class DocumentBasePropertyList : public GroupPropertyList
```
```
...
- [C#](#i-tab-content-f3ca9c88-6a5a-42f3-9214-0a14996cc3fe)
