...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PlaceHolderPropertyList~Property(PlaceHolder).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.PlaceHolder id);
   void set (Properties.PlaceHolder id, PropertyValue^ value);
}
```
```
