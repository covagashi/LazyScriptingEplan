...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectCopyException.html

---

Throw when an error occurred during project copying.
...
```
```
public class ProjectCopyException : DataModelException
```
```

```
```
public ref class ProjectCopyException : public DataModelException
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ProjectCopyException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectCopyException~_ctor.html) | Overloaded. |
