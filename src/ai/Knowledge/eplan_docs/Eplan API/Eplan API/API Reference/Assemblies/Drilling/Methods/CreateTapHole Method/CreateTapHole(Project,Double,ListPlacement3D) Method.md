# CreateTapHole(Project,Double,List<Placement3D>) Method

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Drilling~CreateTapHole(Project,Double,List{Placement3D}).html
...
```
```
public static Drilling CreateTapHole( 
   Project oProject,
   double dDiameter,
