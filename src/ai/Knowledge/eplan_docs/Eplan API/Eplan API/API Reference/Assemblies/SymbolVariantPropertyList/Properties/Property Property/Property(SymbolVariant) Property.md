# Property(SymbolVariant) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariantPropertyList~Property(SymbolVariant).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.SymbolVariant id);
   void set (Properties.SymbolVariant id, PropertyValue^ value);
}
```
```
