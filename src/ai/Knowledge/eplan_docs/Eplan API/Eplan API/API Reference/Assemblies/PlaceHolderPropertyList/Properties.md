...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PlaceHolderPropertyList_properties.html

---

For a list of all members of this type, see [PlaceHolderPropertyList members](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PlaceHolderPropertyList_members.html).
...
| Public Property | [PLACEHOLDER\_DELETE\_AFTER\_USAGE\_IN\_COGINEER](topic711.html) | Remove placeholder object after generation with Eplan Cogineer # 19315. |
| Public Property | [PLACEHOLDER\_DESCRIPTION](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PlaceHolderPropertyList~PLACEHOLDER_DESCRIPTION().html) | Placeholder object description # 19308. |
| Public Property | [PLACEHOLDER\_LASTUSEDVALUESET](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PlaceHolderPropertyList~PLACEHOLDER_LASTUSEDVALUESET().html) | Placeholder object: Last value set selected # 19301. |
| Public Property | [PLACEHOLDER\_NAME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PlaceHolderPropertyList~PLACEHOLDER_NAME().html) | Placeholder object name # 19300. |
| Public Property | [PLACEHOLDER\_USE\_IN\_COGINEER](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PlaceHolderPropertyList~PLACEHOLDER_USE_IN_COGINEER().html) | Use placeholder object in Eplan Cogineer # 19314. |
| Public Property | [PLACEHOLDER\_VALUESET\_NAME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PlaceHolderPropertyList~PLACEHOLDER_VALUESET_NAME(Int32).html) | Value set name # 19303. |
