...
                  **Eplan.EplApi.DataModel.Graphics.HyperLinkPropertyList**
...
public class HyperLinkPropertyList : TextBasePropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class HyperLinkPropertyList : public TextBasePropertyList
```
```
...
- [C#](#i-tab-content-8a83aaa5-73cb-4de2-a5ef-00ee2f4ed315)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [HyperLinkPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLinkPropertyList~_ctor.html) | Overloaded. |
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [DESCRIPTION](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLinkPropertyList~DESCRIPTION().html) | Description (Hyperlink) # 19305. |
...
| Public Property | [FILE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLinkPropertyList~FILE().html) | File / Document # 19304. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLinkPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties. |
...
| Public Property | [TEXT\_CONTENTS](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLinkPropertyList~TEXT_CONTENTS().html) | Text contents # 19201. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of HyperLinkPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLinkPropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. |
