...
               **Eplan.EplApi.DataModel.ReportBlockReferencePropertyList**
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ReportBlockReferencePropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties by AnyPropertyId. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of ReportBlockReferencePropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
