...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PipingDefinition.html

---

This class represents piping definition.
...
               **Eplan.EplApi.DataModel.PipingDefinition**
...
| Public Property | [PipeClass](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PipingDefinition~PipeClass.html) | Gets/Sets pipe class of object. |
| Public Property | [PipingName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PipingDefinition~PipingName.html) | Gets/Sets piping name of object. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PipingDefinition~Properties.html) | .NET Property enabling access to P8 properties of the PipingDefinition object. |
...
| Public Property | [Substance](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PipingDefinition~Substance.html) | Gets/Sets substance name of object. |
| Public Property | [SubstanceState](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PipingDefinition~SubstanceState.html) | Gets/Sets substance state of object. Sets the same property as [PotentialDefinition.SignalName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PotentialDefinition~SignalName.html). |
...
| Public Method | [GetDiameterWithUnit](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PipingDefinition~GetDiameterWithUnit.html) | Gets cross-section / diameter with unit of object. |
