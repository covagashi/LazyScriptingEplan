...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingSegment.html
...
```
```
public class RoutingSegment : Function3D, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase, Eplan.EplApi.DataModel.IPropertyPlacementsContainer
```
```

```
```
public ref class RoutingSegment : public Function3D, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase, Eplan.EplApi.DataModel.IPropertyPlacementsContainer
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [RoutingSegment Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingSegment~_ctor().html) | Default constructor. |
...
| Public Property | [EndVertex](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingSegment~EndVertex.html) | Point in 3d space which is the end of routing segment. |
| Public Property | [FillingDegree](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingSegment~FillingDegree.html) | The degree of routing segment filling in percent. |
...
| Public Property | [GeometricalLength](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingSegment~GeometricalLength.html) | Geometrical length of routing segment. |
...
| Public Property | [IgnoreAtFillingDegreeVisualisation](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingSegment~IgnoreAtFillingDegreeVisualisation.html) | If true, then this routing segment is ignored while calculating any filling degree in P8 project. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingSegment~Properties.html) | .NET Property enabling access to P8 properties of the RoutingSegment object. |
...
| Public Property | [RoutedConnections](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingSegment~RoutedConnections.html) | Connection which are routed by this segment. |
| Public Property | [StartVertex](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingSegment~StartVertex.html) | Point in 3d space which is the beginning of routing segment. |
