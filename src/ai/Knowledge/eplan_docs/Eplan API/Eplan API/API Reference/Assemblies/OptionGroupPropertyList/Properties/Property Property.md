...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroupPropertyList~Property.html
...
| --- | --- |
| [Property(OptionGroup,Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroupPropertyList~Property(OptionGroup,Int32).html) | Method used by operator[] in order to access indexed properties. |
| [Property(OptionGroup)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroupPropertyList~Property(OptionGroup).html) | Method used by operator[] in order to access properties. |
| [Property(AnyPropertyId,Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroupPropertyList~Property(AnyPropertyId,Int32).html) | Method used by operator[] in order to access indexed properties by AnyPropertyId. |
| [Property(AnyPropertyId)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroupPropertyList~Property(AnyPropertyId).html) | Method used by operator[] in order to access properties by AnyPropertyId. |
...
[Properties.OptionGroup Enumeration](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Properties+OptionGroup.html)