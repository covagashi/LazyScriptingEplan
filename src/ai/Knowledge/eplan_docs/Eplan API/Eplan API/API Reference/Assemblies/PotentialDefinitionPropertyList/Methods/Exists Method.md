...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PotentialDefinitionPropertyList~Exists.html
...
| --- | --- |
| [Exists(PotentialDefinition)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PotentialDefinitionPropertyList~Exists(PotentialDefinition).html) | Checks property existence for used obiect. |
