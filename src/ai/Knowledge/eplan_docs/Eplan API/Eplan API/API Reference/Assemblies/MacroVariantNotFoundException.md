...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroVariantNotFoundException.html

---

Thrown when specified variant wasn't found in macro.
...
               **Eplan.EplApi.DataModel.MacroVariantNotFoundException**
...
```
```
public class MacroVariantNotFoundException : InvalidArgumentException
```
```

```
```
public ref class MacroVariantNotFoundException : public InvalidArgumentException
```
```
