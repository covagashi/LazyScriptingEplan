...
                  **Eplan.EplApi.DataModel.Graphics.PropertyPlacementPropertyList**  
...
public class PropertyPlacementPropertyList : TextBasePropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class PropertyPlacementPropertyList : public TextBasePropertyList
```
```
...
- [C#](#i-tab-content-2f410041-c90c-4bfa-9fbd-7c09a575cd3a)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [PropertyPlacementPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PropertyPlacementPropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PropertyPlacementPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties by AnyPropertyId. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of PropertyPlacementPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
