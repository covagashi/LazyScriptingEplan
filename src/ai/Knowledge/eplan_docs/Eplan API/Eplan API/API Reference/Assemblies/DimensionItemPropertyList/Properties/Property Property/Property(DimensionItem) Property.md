# Property(DimensionItem) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionItemPropertyList~Property(DimensionItem).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.DimensionItem id);
   void set (Properties.DimensionItem id, PropertyValue^ value);
}
```
```
