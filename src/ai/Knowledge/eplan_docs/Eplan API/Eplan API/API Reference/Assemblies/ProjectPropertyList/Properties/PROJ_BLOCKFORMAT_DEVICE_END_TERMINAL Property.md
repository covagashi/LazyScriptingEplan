...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_BLOCKFORMAT_DEVICE_END_TERMINAL(Int32).html
...
```
public:
property PropertyValue^ PROJ_BLOCKFORMAT_DEVICE_END_TERMINAL {
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_BLOCKFORMAT_DEVICE_END_TERMINAL.html)