...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_EXTERNAL_DOCUMENT_5().html
...
```
```
public PropertyValue ARTICLE_EXTERNAL_DOCUMENT_5 {get; set;}
```
```
...
```
public:
property PropertyValue^ ARTICLE_EXTERNAL_DOCUMENT_5 {
   PropertyValue^ get();
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_EXTERNAL_DOCUMENT_5.html)