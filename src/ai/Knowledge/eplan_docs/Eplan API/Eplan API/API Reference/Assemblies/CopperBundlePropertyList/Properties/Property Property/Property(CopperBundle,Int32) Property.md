# Property(CopperBundle,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.CopperBundlePropertyList~Property(CopperBundle,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.CopperBundle id, int index);
   void set (Properties.CopperBundle id, int index, PropertyValue^ value);
}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.CopperBundlePropertyList~Property.html)
