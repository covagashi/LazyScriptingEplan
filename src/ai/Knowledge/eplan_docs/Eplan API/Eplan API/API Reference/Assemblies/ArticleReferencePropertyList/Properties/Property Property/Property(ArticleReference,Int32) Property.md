# Property(ArticleReference,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~Property(ArticleReference,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.ArticleReference id, int index);
   void set (Properties.ArticleReference id, int index, PropertyValue^ value);
}
```
```
...
*index*
:   Index of the ArticleReference's property
