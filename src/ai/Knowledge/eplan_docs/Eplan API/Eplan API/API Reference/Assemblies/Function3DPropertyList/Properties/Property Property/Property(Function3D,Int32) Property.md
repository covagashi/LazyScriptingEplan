# Property(Function3D,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Function3DPropertyList~Property(Function3D,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Function3D id, int index);
   void set (Properties.Function3D id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the Function3D's property

*index*
:   Index of the Function3D's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Function3DPropertyList~Property.html)
