...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingHose.html

---

Represents 3D object of routing accessory in P8.
...
               **Eplan.EplApi.DataModel.E3D.RoutingHose**
...
| Public Property | [Diameter](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingAccessory~Diameter.html) | Gets and sets diameter of this object. (Inherited from [Eplan.EplApi.DataModel.E3D.RoutingAccessory](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingAccessory.html)) |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingHose~Properties.html) | .NET Property enabling access to EPLAN properties of the routing hose object. |
...
| Public Property | [RouteNodes](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingHose~RouteNodes.html) | Array of route elements space through which routing hose is routed. |
| Public Property | [RoutePoints](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingHose~RoutePoints.html) | Array of points in 3d space through which routing hose is routed. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingHose~Create.html) | Overloaded. Creates not placed routing accessory object. |
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.RoutingHose~CreateTransient.html) | Overloaded. Creates transient and not placed routing accessory object. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of routing hose object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
