# Property(OptionGroup) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroupPropertyList~Property(OptionGroup).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.OptionGroup id);
   void set (Properties.OptionGroup id, PropertyValue^ value);
}
```
```
