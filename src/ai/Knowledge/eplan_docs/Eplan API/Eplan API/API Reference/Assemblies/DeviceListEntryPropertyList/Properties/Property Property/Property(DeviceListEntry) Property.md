# Property(DeviceListEntry) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceListEntryPropertyList~Property(DeviceListEntry).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.DeviceListEntry id);
   void set (Properties.DeviceListEntry id, PropertyValue^ value);
}
```
```
