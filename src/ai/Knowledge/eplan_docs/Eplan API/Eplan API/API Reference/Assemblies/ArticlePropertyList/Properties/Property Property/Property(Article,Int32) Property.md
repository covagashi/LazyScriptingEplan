# Property(Article,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~Property(Article,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Article id, int index);
   void set (Properties.Article id, int index, PropertyValue^ value);
}
```
```
...
*index*
:   Index of the Article's property
