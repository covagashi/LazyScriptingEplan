# Property(SymbolReference) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.SymbolReferencePropertyList~Property(SymbolReference).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.SymbolReference id);
   void set (Properties.SymbolReference id, PropertyValue^ value);
}
```
```
