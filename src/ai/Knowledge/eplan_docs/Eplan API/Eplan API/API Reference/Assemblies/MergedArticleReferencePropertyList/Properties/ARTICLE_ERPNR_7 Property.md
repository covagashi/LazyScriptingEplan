# ARTICLE_ERPNR_7 Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_ERPNR_7().html
...
```
public:
property PropertyValue^ ARTICLE_ERPNR_7 {
   PropertyValue^ get();
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_ERPNR_7.html)