...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~CONNECTION_USERDEFINED_AUTOMATIC().html
...
```
public:
property PropertyValue^ CONNECTION_USERDEFINED_AUTOMATIC {
   PropertyValue^ get();
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~CONNECTION_USERDEFINED_AUTOMATIC.html)