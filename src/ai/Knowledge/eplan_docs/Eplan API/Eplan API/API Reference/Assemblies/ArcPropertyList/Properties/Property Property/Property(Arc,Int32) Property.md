# Property(Arc,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~Property(Arc,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Arc id, int index);
   void set (Properties.Arc id, int index, PropertyValue^ value);
}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~Property.html)
