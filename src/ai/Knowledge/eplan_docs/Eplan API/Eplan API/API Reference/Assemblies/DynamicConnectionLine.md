...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DynamicConnectionLine.html

---

This class represents dynamic connection lines in the project.
...
            **Eplan.EplApi.DataModel.DynamicConnectionLine**
...
```
```
public class DynamicConnectionLine : SymbolReference, IPropertyPlacementsContainer
```
```

```
```
public ref class DynamicConnectionLine : public SymbolReference, IPropertyPlacementsContainer
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [DynamicConnectionLine Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DynamicConnectionLine~_ctor().html) | constructor, creates transient object. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DynamicConnectionLine~Properties.html) | .NET Property enabling access to P8 properties of the DynamicConnectionLine object. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DynamicConnectionLine~Create.html) | Overloaded. Creates DynamicConnectionLine object. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of DynamicConnectionLine object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
...
| Public Method | [GetFirstEmbeddedInstance](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DynamicConnectionLine~GetFirstEmbeddedInstance.html) | Returns first instance embedded in this line. |
| Public Method | [GetGraphics](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DynamicConnectionLine~GetGraphics.html) | Gets graphical representation of the DynamicConnectionLine. |
...
| Public Method | [GetNextEmbeddedInstance](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DynamicConnectionLine~GetNextEmbeddedInstance.html) | Returns next instance embedded in this line after one given as a parameter. |
...
| Public Method | [SetGraphics](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DynamicConnectionLine~SetGraphics.html) | Sets graphic representation from 2 points. |
