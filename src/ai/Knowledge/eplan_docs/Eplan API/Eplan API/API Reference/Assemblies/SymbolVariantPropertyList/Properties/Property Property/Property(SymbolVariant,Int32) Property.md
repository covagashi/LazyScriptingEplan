# Property(SymbolVariant,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariantPropertyList~Property(SymbolVariant,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.SymbolVariant id, int index);
   void set (Properties.SymbolVariant id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the SymbolVariant's property

*index*
:   Index of the SymbolVariant's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariantPropertyList~Property.html)
