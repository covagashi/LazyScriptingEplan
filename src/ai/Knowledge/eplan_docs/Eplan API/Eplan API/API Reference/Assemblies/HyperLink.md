...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLink.html

---

This class represents hyperlinks.
...
               **Eplan.EplApi.DataModel.Graphics.HyperLink**
...
```
```
public class HyperLink : TextBase
```
```

```
```
public ref class HyperLink : public TextBase
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [HyperLink Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLink~_ctor().html) | Constructor. When object created with this constructor, its `create` method must be call. |
...
| Public Property | [Comment](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLink~Comment.html) | Returns comment related to the hyperlink. |
| Public Property | [Contents](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.HyperLink~Contents.html) | Overridden. Contents of object represented by this type. |
