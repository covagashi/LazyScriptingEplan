...
               **Eplan.EplApi.DataModel.DynamicConnectionLinePropertyList**
...
public class DynamicConnectionLinePropertyList : SymbolReferencePropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class DynamicConnectionLinePropertyList : public SymbolReferencePropertyList
```
```
...
- [C#](#i-tab-content-4e3e026f-24c9-4f01-b3c4-49a6640c1905)
