# Property(Comment,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.CommentPropertyList~Property(Comment,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Comment id, int index);
   void set (Properties.Comment id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the Comment's property

*index*
:   Index of the Comment's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.CommentPropertyList~Property.html)
