...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlacementPropertyList~Exists.html
...
| --- | --- |
| [Exists(Placement)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlacementPropertyList~Exists(Placement).html) | Checks property existence for used obiect. |
