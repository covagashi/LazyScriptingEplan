...
                        **Eplan.EplApi.DataModel.E3D.ContextPropertyPlacement3DPropertyList**
...
public class ContextPropertyPlacement3DPropertyList : Eplan.EplApi.DataModel.ContextPropertyPlacementPropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class ContextPropertyPlacement3DPropertyList : public Eplan.EplApi.DataModel.ContextPropertyPlacementPropertyList
```
```
...
- [C#](#i-tab-content-2bc022eb-b1b9-4ba3-a600-debb283b94f1)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ContextPropertyPlacement3DPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.ContextPropertyPlacement3DPropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.ContextPropertyPlacement3DPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties by AnyPropertyId. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of ContextPropertyPlacement3DPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBasePropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. (Inherited from [Eplan.EplApi.DataModel.Graphics.TextBasePropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBasePropertyList.html)) |
