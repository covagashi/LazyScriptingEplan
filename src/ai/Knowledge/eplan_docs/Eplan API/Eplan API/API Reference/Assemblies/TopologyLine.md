...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TopologyLine.html

---

Represents a topology connection line.
...
               **Eplan.EplApi.DataModel.Graphics.TopologyLine**
...
```
```
public class TopologyLine : Line
```
```

```
```
public ref class TopologyLine : public Line
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [TopologyLine Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TopologyLine~_ctor().html) | Default constructor. |
...
| Public Property | [EndArrow](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line~EndArrow.html) | Returns if Line is ended with an arrow. (Inherited from [Eplan.EplApi.DataModel.Graphics.Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html)) |
| Public Property | [EndPoint](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line~EndPoint.html) | Returns Line's end point. (Inherited from [Eplan.EplApi.DataModel.Graphics.Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html)) |
| Public Property | [Extension](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line~Extension.html) | Returns if Line has an extension. (Inherited from [Eplan.EplApi.DataModel.Graphics.Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html)) |
...
| Public Property | [IsDirectLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TopologyLine~IsDirectLine.html) | Returns true if topology line is a direct line. |
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line~Location.html) | Get or set the placement's location. (Inherited from [Eplan.EplApi.DataModel.Graphics.Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html)) |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TopologyLine~Properties.html) | .NET Property enabling access to P8 properties of the TopologyLine object. |
| Public Property | [StartArrow](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line~StartArrow.html) | Returns if Line starts with an arrow. (Inherited from [Eplan.EplApi.DataModel.Graphics.Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html)) |
| Public Property | [StartPoint](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line~StartPoint.html) | Returns Line's start point. (Inherited from [Eplan.EplApi.DataModel.Graphics.Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html)) |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line~Create.html) | Overloaded. Creates the Line object. (Inherited from [Eplan.EplApi.DataModel.Graphics.Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html)) |
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line~CreateTransient.html) | Creates transient and not placed Line object. (Inherited from [Eplan.EplApi.DataModel.Graphics.Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html)) |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of TopologyLine object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
