...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.LocationPropertyList~Property(Location).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Location id);
   void set (Properties.Location id, PropertyValue^ value);
}
```
```
