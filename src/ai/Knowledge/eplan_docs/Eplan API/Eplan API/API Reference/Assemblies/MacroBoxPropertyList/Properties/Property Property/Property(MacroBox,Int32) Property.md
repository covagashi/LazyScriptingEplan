# Property(MacroBox,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroBoxPropertyList~Property(MacroBox,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.MacroBox id, int index);
   void set (Properties.MacroBox id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the MacroBox's property

*index*
:   Index of the MacroBox's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroBoxPropertyList~Property.html)
