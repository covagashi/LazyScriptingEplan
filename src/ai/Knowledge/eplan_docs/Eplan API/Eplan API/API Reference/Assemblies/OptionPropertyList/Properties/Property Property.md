...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionPropertyList~Property.html
...
| --- | --- |
| [Property(Option,Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionPropertyList~Property(Option,Int32).html) | Method used by operator[] in order to access indexed properties. |
| [Property(Option)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionPropertyList~Property(Option).html) | Method used by operator[] in order to access properties. |
| [Property(AnyPropertyId,Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionPropertyList~Property(AnyPropertyId,Int32).html) | Method used by operator[] in order to access indexed properties by AnyPropertyId. |
| [Property(AnyPropertyId)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionPropertyList~Property(AnyPropertyId).html) | Method used by operator[] in order to access properties by AnyPropertyId. |
...
[Properties.Option Enumeration](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Properties+Option.html)