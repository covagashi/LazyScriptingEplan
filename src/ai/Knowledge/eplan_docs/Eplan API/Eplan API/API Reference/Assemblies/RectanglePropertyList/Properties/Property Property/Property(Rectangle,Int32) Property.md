# Property(Rectangle,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.RectanglePropertyList~Property(Rectangle,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Rectangle id, int index);
   void set (Properties.Rectangle id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the Rectangle's property

*index*
:   Index of the Rectangle's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.RectanglePropertyList~Property.html)
