...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FixedDeviceException.html

---

Throw when device of datamodel object is fixed and ArticleReference is being changed.
...
```
```
public class FixedDeviceException : DataModelException
```
```

```
```
public ref class FixedDeviceException : public DataModelException
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [FixedDeviceException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FixedDeviceException~_ctor.html) | Overloaded. |
