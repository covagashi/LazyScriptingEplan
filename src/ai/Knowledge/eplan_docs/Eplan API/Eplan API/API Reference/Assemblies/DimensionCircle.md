...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle.html

---

This class represents circle dimension on the page.
...
            **Eplan.EplApi.DataModel.Graphics.DimensionCircle**
...
```
```
public class DimensionCircle : GraphicalPlacement
```
```

```
```
public ref class DimensionCircle : public GraphicalPlacement
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [DimensionCircle Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~_ctor().html) | Constructor. When object created with this constructor, its `create` method must be call. |
...
| Public Property | [DimensionCalculated](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionCalculated.html) | Gets/Sets whether the value of the dimension (the dimension's text) is automatically calculated. |
| Public Property | [DimensionDisableZero](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionDisableZero.html) | Gets/Sets whether the precision is set or not. |
| Public Property | [DimensionDistanceToLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionDistanceToLine.html) | Gets/Sets the distance of the dimension text to the dimension line. |
| Public Property | [DimensionPositionCalculated](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionPositionCalculated.html) | Gets/Sets whether the dimension's text is automatically positioned (in relation to the dimension item itself). |
| Public Property | [DimensionPrecision](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionPrecision.html) | Gets/Sets the precision of the dimension circle. |
| Public Property | [DimensionPrefix](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionPrefix.html) | Gets/Sets the prefix of the dimension circle. |
| Public Property | [DimensionShowUnits](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionShowUnits.html) | Gets/Sets whether the unit is displayed or not. |
| Public Property | [DimensionSuffix](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionSuffix.html) | Gets/sets the suffix of the dimension circle. |
| Public Property | [DimensionText](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionText.html) | Gets/Sets the value of the dimension circle. |
| Public Property | [DimensionUnit](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~DimensionUnit.html) | Gets/Sets the unit of the dimension circle. |
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~Location.html) | Overridden. Get or set the placement's location. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~Properties.html) |  |
| Public Property | [TextColor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~TextColor.html) | Color for displayed text. Color index (0-255) Please use -16002 as "From layer" value. Predefined values for line colour index are:  0 = black  1 = red  2 = yellow  3 = green  4 = cyan  5 = blue  6 = magenta  7 = white  252 = darkgray  253 = gray |
| Public Property | [TextFontInfo](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~TextFontInfo.html) | Font for displayed text. |
| Public Property | [TextHeight](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~TextHeight.html) | Returns height of the Text. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCircle~Create.html) | Overloaded. Creates the DimensionCircle object. |
