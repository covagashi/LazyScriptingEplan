# Property(SymbolReference,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.SymbolReferencePropertyList~Property(SymbolReference,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.SymbolReference id, int index);
   void set (Properties.SymbolReference id, int index, PropertyValue^ value);
}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.SymbolReferencePropertyList~Property.html)
