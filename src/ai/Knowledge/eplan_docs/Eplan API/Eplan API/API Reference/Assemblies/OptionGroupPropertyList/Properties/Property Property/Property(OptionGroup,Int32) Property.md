# Property(OptionGroup,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroupPropertyList~Property(OptionGroup,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.OptionGroup id, int index);
   void set (Properties.OptionGroup id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the OptionGroup's property

*index*
:   Index of the OptionGroup's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroupPropertyList~Property.html)
