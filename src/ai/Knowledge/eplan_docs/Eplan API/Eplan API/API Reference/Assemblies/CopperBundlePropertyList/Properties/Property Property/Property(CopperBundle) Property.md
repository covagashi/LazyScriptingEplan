# Property(CopperBundle) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.CopperBundlePropertyList~Property(CopperBundle).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.CopperBundle id);
   void set (Properties.CopperBundle id, PropertyValue^ value);
}
```
```
