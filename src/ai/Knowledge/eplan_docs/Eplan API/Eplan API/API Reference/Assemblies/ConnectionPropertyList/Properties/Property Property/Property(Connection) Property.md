...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~Property(Connection).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Connection id);
   void set (Properties.Connection id, PropertyValue^ value);
}
```
```
