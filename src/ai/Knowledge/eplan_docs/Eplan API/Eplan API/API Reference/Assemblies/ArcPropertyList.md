...
               **Eplan.EplApi.DataModel.Graphics.ArcPropertyList**
...
public class ArcPropertyList : GraphicalPlacementPropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class ArcPropertyList : public GraphicalPlacementPropertyList
```
```
...
- [C#](#i-tab-content-47ededf0-b672-44f7-9fba-a670876acc29)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ArcPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~_ctor.html) | Overloaded. |
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [DMG\_ARC\_CENTER\_X](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~DMG_ARC_CENTER_X().html) | X coordinate of the center # 19321. |
| Public Property | [DMG\_ARC\_CENTER\_Y](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~DMG_ARC_CENTER_Y().html) | Y coordinate of the center # 19322. |
| Public Property | [DMG\_ARC\_ENDANGLE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~DMG_ARC_ENDANGLE().html) | End angle # 19324. |
| Public Property | [DMG\_ARC\_RADIUS](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~DMG_ARC_RADIUS().html) | Circle radius # 19320. |
| Public Property | [DMG\_ARC\_STARTANGLE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~DMG_ARC_STARTANGLE().html) | Starting angle # 19323. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of ArcPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ArcPropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. |
