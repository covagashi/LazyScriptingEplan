# Property(Connection,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~Property(Connection,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Connection id, int index);
   void set (Properties.Connection id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the Connection's property

*index*
:   Index of the Connection's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~Property.html)
