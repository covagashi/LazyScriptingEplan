...
               **Eplan.EplApi.DataModel.StrandInterConnectorPropertyList**
...
public class StrandInterConnectorPropertyList : SymbolReferencePropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class StrandInterConnectorPropertyList : public SymbolReferencePropertyList
```
```
...
- [C#](#i-tab-content-c22fd816-2e6f-44a1-9a47-0f68272615a8)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [StrandInterConnectorPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandInterConnectorPropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandInterConnectorPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties by AnyPropertyId. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of StrandInterConnectorPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
