...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Group3DPropertyList.html

---

This class represents collection of properties of [Group3D](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Group3D.html) class. Please check also base classes for other properties which are available for [Group3D](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Group3D.html) objects: [Eplan.EplApi.DataModel.StorableObjectPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObjectPropertyList.html)
...
         **Eplan.EplApi.DataModel.E3D.Group3DPropertyList**
...
public class Group3DPropertyList : Eplan.EplApi.DataModel.StorableObjectPropertyList
```
```
...
```
[DefaultMember("Property")]
public ref class Group3DPropertyList : public Eplan.EplApi.DataModel.StorableObjectPropertyList
```
```
...
- [C#](#i-tab-content-60ac02a8-0daf-45f1-8027-5a2719d4ef90)
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of Group3DPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
