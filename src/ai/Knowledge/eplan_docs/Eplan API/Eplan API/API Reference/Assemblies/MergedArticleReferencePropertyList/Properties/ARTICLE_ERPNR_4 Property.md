# ARTICLE_ERPNR_4 Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_ERPNR_4().html
...
```
```
public PropertyValue ARTICLE_ERPNR_4 {get; set;}
```
```
...
```
public:
property PropertyValue^ ARTICLE_ERPNR_4 {
   PropertyValue^ get();
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_ERPNR_4.html)