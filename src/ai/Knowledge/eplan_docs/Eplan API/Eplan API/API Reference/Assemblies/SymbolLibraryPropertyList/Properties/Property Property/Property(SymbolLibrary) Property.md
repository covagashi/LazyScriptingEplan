# Property(SymbolLibrary) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolLibraryPropertyList~Property(SymbolLibrary).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.SymbolLibrary id);
   void set (Properties.SymbolLibrary id, PropertyValue^ value);
}
```
```
