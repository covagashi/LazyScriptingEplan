# Property(Symbol,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~Property(Symbol,Int32).html
...
property PropertyValue^ Property {
   PropertyValue^ get(Properties.Symbol id, int index);
   void set (Properties.Symbol id, int index, PropertyValue^ value);
}
```
```
...
*id*
:   Identifier of the Symbol's property

*index*
:   Index of the Symbol's property
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~Property.html)
