...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Export3D~CopperForNC.html
...
*strMaterialName*
:   Name of material on which bus bar will be made. If name will be invalid then default material is being used for export.
