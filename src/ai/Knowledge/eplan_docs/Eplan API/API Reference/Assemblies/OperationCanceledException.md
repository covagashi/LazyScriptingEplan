...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OperationCanceledException.html

---

This exception throws when user (or someone else?) cancel operation. For example ProgressBar provide possibility to press button Cancel.
...
public class OperationCanceledException : DataModelException

public ref class OperationCanceledException : public DataModelException

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [OperationCanceledException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OperationCanceledException~_ctor.html) | Overloaded. |
