...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Spline.html

---

This class represents spline placed on the [Eplan.EplApi.DataModel.Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html).
...
               **Eplan.EplApi.DataModel.Graphics.Spline**
...
public ref class Spline : public PolyLine

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [Spline Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Spline~_ctor().html) | Constructor. When object created with this constructor, its `create` method must be call. |
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [Closed](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~Closed.html) | True, if the poly line is closed. (Inherited from [Eplan.EplApi.DataModel.Graphics.PolyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html)) |
...
| Public Property | [FillPattern](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~FillPattern.html) | Gets or sets the fill pattern of the PolyLine. Pattern types Bitmap, Eplan and System are not supported. (Inherited from [Eplan.EplApi.DataModel.Graphics.PolyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html)) |
...
| Public Property | [IsSurfaceFilled](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~IsSurfaceFilled.html) | This property specifies if the polyline is filled. When the polyline is not closed setting this property throws an exception (Inherited from [Eplan.EplApi.DataModel.Graphics.PolyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html)) |
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~Location.html) | Get or set the placement's location. (Inherited from [Eplan.EplApi.DataModel.Graphics.PolyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html)) |
| Public Property | [NumberOfPoints](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~NumberOfPoints.html) | Number of vertices of a poly line. (Inherited from [Eplan.EplApi.DataModel.Graphics.PolyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html)) |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Spline~Properties.html) | .NET Property enabling access to P8 properties of the Spline object. |
...
| Public Methodstatic (Shared in Visual Basic) | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Spline~Create.html) | Overloaded. Creates a Spline object. |
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Spline~CreateTransient.html) | Overridden. Creates transient and not placed PolyLine object. |
...
| Public Method | [GetBulgeAt](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~GetBulgeAt.html) | Returns the corner arc of one vertex of a poly line (Inherited from [Eplan.EplApi.DataModel.Graphics.PolyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html)) |
...
| Public Method | [GetPointAt](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~GetPointAt.html) | Returns the coordinates of a vertex of a polyline (Inherited from [Eplan.EplApi.DataModel.Graphics.PolyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html)) |
...
| Public Method | [SetBulgeAt](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~SetBulgeAt.html) | Sets the corner arc of one vertex of a poly line (Inherited from [Eplan.EplApi.DataModel.Graphics.PolyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html)) |
| Public Method | [SetPointAt](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~SetPointAt.html) | Sets one vertex of a polyline If the index of this point does not yet exist it will be added. (Inherited from [Eplan.EplApi.DataModel.Graphics.PolyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html)) |
