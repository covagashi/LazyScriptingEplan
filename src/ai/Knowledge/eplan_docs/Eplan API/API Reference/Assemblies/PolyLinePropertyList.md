...
               **Eplan.EplApi.DataModel.Graphics.PolyLinePropertyList**  
...
public class PolyLinePropertyList : GraphicalPlacementPropertyList
```
```
...
public ref class PolyLinePropertyList : public GraphicalPlacementPropertyList
```
```
...
- [C#](#i-tab-content-8607d687-92b6-4490-ba4e-75587b80d2d5)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [PolyLinePropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLinePropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLinePropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties by AnyPropertyId. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of PolyLinePropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
