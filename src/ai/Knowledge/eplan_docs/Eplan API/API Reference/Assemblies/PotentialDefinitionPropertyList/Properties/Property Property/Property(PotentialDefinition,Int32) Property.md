# Property(PotentialDefinition,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PotentialDefinitionPropertyList~Property(PotentialDefinition,Int32).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.PotentialDefinition id, int index);

   void set (Properties.PotentialDefinition id, int index, PropertyValue^ value);
...
*index*
:   Index of the PotentialDefinition's property
