# Property(QRCode,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCodePropertyList~Property(QRCode,Int32).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.QRCode id, int index);

   void set (Properties.QRCode id, int index, PropertyValue^ value);
...
*index*
:   Index of the QRCode's property
