...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DocumentBase.html

---

This class is a base class for [Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html).
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DocumentBase~Location.html) | Overridden. Get or set the placement's location. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DocumentBase~Properties.html) | .NET Property enabling access to P8 properties of the DocumentBase object. |
