...
               **Eplan.EplApi.DataModel.DimensionGroupPropertyList**
...
public class DimensionGroupPropertyList : GroupPropertyList
```
```
...
public ref class DimensionGroupPropertyList : public GroupPropertyList
```
```
...
- [C#](#i-tab-content-295ea3dd-d304-4529-88a9-6bad12e9e4d1)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [DimensionGroupPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DimensionGroupPropertyList~_ctor.html) | Overloaded. |
