...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroup.html

---

This class represents ProtectedGroup.
...
            **Eplan.EplApi.DataModel.ProtectedGroup**
...
public class ProtectedGroup : Group, IPlacementsContainer

public ref class ProtectedGroup : public Group, IPlacementsContainer
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroup~Properties.html) | .NET Property enabling access to P8 properties of the ProtectedGroup object. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of ProtectedGroup object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
