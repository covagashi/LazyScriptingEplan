...
                  **Eplan.EplApi.DataModel.Graphics.LockedMountingAreaPropertyList**
...
public class LockedMountingAreaPropertyList : RectanglePropertyList
```
```
...
public ref class LockedMountingAreaPropertyList : public RectanglePropertyList
```
```
...
- [C#](#i-tab-content-0ac26403-0c71-4110-b161-7860c3becbb2)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [LockedMountingAreaPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingAreaPropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingAreaPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties by AnyPropertyId. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of LockedMountingAreaPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.RectanglePropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. (Inherited from [Eplan.EplApi.DataModel.Graphics.RectanglePropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.RectanglePropertyList.html)) |
