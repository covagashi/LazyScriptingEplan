...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingArea.html

---

This class is a reserved area which can be set on a mounting panel. It is forbidden to set article placements into this area.
...
               **Eplan.EplApi.DataModel.Graphics.LockedMountingArea**
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [Angle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~Angle.html) | Returns angle. (Inherited from [Eplan.EplApi.DataModel.Graphics.Rectangle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html)) |
| Public Property | [ChamferRadius](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~ChamferRadius.html) | Returns radius of Rectangle's corners chamfers. (Inherited from [Eplan.EplApi.DataModel.Graphics.Rectangle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html)) |
...
| Public Property | [FillPattern](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~FillPattern.html) | Gets or sets the fill pattern. Pattern types Bitmap, Eplan and System are not supported. (Inherited from [Eplan.EplApi.DataModel.Graphics.Rectangle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html)) |
...
| Public Property | [HasChamfers](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~HasChamfers.html) | Returns if the rectangle has chamfers. (Inherited from [Eplan.EplApi.DataModel.Graphics.Rectangle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html)) |
| Public Property | [Height](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~Height.html) | Returns height of the rectangle. (Inherited from [Eplan.EplApi.DataModel.Graphics.Rectangle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html)) |
...
| Public Property | [IsSurfaceFilled](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~IsSurfaceFilled.html) | This property specifies if the rectangle is filled. (Inherited from [Eplan.EplApi.DataModel.Graphics.Rectangle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html)) |
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~Location.html) | Get or set the placement's location. (Inherited from [Eplan.EplApi.DataModel.Graphics.Rectangle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html)) |
| Public Property | [LowerLeftCorner](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~LowerLeftCorner.html) | Returns lower left corner's coordinates. (Inherited from [Eplan.EplApi.DataModel.Graphics.Rectangle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html)) |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingArea~Properties.html) | .NET Property enabling access to P8 properties of the LockedMountingArea object. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingArea~Create.html) | Overloaded. Overridden. Creates the Rectangle object. |
| Public Method | [CreateEmbedded](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingArea~CreateEmbedded.html) | Creates an embedded object. |
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingArea~CreateTransient.html) | Overridden. Creates transient and not placed Rectangle object. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Default Destructor (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
...
| Public Method | [SetArea](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~SetArea.html) | Sets the size of a rectangle using the coordinates of the two opposite corners (Inherited from [Eplan.EplApi.DataModel.Graphics.Rectangle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html)) |
