...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode.html

---

This class represents QRCode.
...
               **Eplan.EplApi.DataModel.Graphics.QRCode**
...
```
```
public ref class QRCode : public Rectangle
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [BlockFormat](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode~BlockFormat.html) | Gets/sets block format of QRCode. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode~Properties.html) | .NET Property enabling access to P8 properties of the QRCode object. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode~Create.html) | Overloaded. Creates the QRCode object. |
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode~CreateTransient.html) | Overridden. Creates transient and not placed Rectangle object. |
...
| Public Method | [GetQRCode](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode~GetQRCode.html) | Get's stored QRCode string. |
...
| Public Method | [Scale](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode~Scale.html) | Overloaded. Overridden. Scales the placement (or group of placements) by the specified factors in X and Y axis with scaling origin point specified by the ptOrigin parameter. |
| Public Method | [SetArea](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode~SetArea.html) | Overridden. Sets the size of a rectangle using the coordinates of the two opposite corners |
| Public Method | [SetAreaBySize](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode~SetAreaBySize.html) | Sets the size of an QRCode. |
