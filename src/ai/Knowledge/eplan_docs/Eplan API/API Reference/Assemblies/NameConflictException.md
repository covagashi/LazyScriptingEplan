...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NameConflictException.html

---

Thrown when specified name already exists. It's used for example in [Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html) names.
...
                  **Eplan.EplApi.DataModel.NameConflictException**
...
| Public Property | [Name](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NameConflictException~Name.html) | Returns the invalid name. |
