# Property(DeletedObjectInfo,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeletedObjectInfoPropertyList~Property(DeletedObjectInfo,Int32).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.DeletedObjectInfo id, int index);

   void set (Properties.DeletedObjectInfo id, int index, PropertyValue^ value);
...
*index*
:   Index of the DeletedObjectInfo's property
