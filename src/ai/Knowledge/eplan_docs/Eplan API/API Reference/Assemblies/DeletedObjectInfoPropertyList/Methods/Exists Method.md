...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeletedObjectInfoPropertyList~Exists.html
...
| --- | --- |
| [Exists(DeletedObjectInfo)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeletedObjectInfoPropertyList~Exists(DeletedObjectInfo).html) | Checks property existence for used obiect. |
