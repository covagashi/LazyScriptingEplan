...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.FunctionDefinitionLibraryPropertyList~Property.html
...
| --- | --- |
| [Property(FunctionDefinitionLibrary,Int32)](topic729.html) | Method used by operator[] in order to access indexed properties. |
| [Property(FunctionDefinitionLibrary)](topic730.html) | Method used by operator[] in order to access properties. |
| [Property(AnyPropertyId,Int32)](topic731.html) | Method used by operator[] in order to access indexed properties by AnyPropertyId. |
| [Property(AnyPropertyId)](topic732.html) | Method used by operator[] in order to access properties by AnyPropertyId. |
