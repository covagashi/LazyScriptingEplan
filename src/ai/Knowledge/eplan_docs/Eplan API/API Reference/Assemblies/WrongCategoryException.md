...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.WrongCategoryException.html

---

Throw when there is an error related to a Function's category, for example someone tries to change the category of a Plug object to `TERMINAL`, or get a parent TerminalStrip from a Terminal assigned to a PLC object.
...
```
```
public class WrongCategoryException : DataModelException
```
```

```
```
public ref class WrongCategoryException : public DataModelException
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [WrongCategoryException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.WrongCategoryException~_ctor.html) | Overloaded. |
