...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDObjectCreationException.html

---

Thrown when MasterData object cannot be created.
...
public class MDObjectCreationException : MasterDataException

public ref class MDObjectCreationException : public MasterDataException

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [MDObjectCreationException Constructor](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDObjectCreationException~_ctor.html) | Overloaded. |
