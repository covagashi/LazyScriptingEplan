...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NoSuchPinException.html

---

Throw when the the User want to set PlcTrackingOneBased on the pin that doesn't exist.
...
public class NoSuchPinException : DataModelException

public ref class NoSuchPinException : public DataModelException

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [NoSuchPinException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NoSuchPinException~_ctor.html) | Overloaded. |
