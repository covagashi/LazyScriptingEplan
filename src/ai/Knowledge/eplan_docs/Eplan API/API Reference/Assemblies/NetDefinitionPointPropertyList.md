...
                  **Eplan.EplApi.DataModel.NetDefinitionPointPropertyList**
...
public class NetDefinitionPointPropertyList : PotentialDefinitionPropertyList
```
```
...
public ref class NetDefinitionPointPropertyList : public PotentialDefinitionPropertyList
```
```
...
- [C#](#i-tab-content-d18c5643-be1f-471b-87b5-31ad1daa9175)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [NetDefinitionPointPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPointPropertyList~_ctor.html) | Overloaded. |
