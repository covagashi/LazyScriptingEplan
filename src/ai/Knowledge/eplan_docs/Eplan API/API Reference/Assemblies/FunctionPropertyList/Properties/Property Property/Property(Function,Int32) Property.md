# Property(Function,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~Property(Function,Int32).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.Function id, int index);

   void set (Properties.Function id, int index, PropertyValue^ value);
...
*index*
:   Index of the Function's property
