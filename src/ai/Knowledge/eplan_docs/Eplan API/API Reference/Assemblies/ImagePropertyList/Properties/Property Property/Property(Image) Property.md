...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ImagePropertyList~Property(Image).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.Image id);

   void set (Properties.Image id, PropertyValue^ value);
