...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionBasePropertyList~Exists.html
...
| --- | --- |
| [Exists(FunctionBase)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionBasePropertyList~Exists(FunctionBase).html) | Checks property existence for used obiect. |
