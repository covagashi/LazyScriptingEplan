...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.PlcService~ExportData(Project,String,String,String,String,Boolean).html
...
Use the GetAvailableConverters method to get the list of registered PLC data converters. If the given directory in the full file name does not exist, it will be created.
