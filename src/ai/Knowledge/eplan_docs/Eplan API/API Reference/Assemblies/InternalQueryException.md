...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InternalQueryException.html

---

Throw when data model internal query cannot get the result.
...
public class InternalQueryException : DataModelException

public ref class InternalQueryException : public DataModelException

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [InternalQueryException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InternalQueryException~_ctor.html) | Overloaded. |
