...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PathText.html

---

This class represents path function text object on the [Eplan.EplApi.DataModel.Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html).
...
                  **Eplan.EplApi.DataModel.Graphics.PathText**
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PathText~Properties.html) | .NET Property enabling access to P8 properties of the PathText object. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PathText~Create.html) | Overloaded. Overridden. Creates the Text object. |
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PathText~CreateTransient.html) | Overloaded. Creates transient and not placed PathText object. |
...
| Public Method | [ToPathText](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PathText~ToPathText.html) | Overridden. Transforms this Text instance into a PathText instance. |
