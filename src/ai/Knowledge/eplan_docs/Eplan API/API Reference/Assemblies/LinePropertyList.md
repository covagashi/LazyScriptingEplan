...
               **Eplan.EplApi.DataModel.Graphics.LinePropertyList**  
...
public class LinePropertyList : GraphicalPlacementPropertyList
```
```
...
public ref class LinePropertyList : public GraphicalPlacementPropertyList
```
```
...
- [C#](#i-tab-content-4ecd942b-28ec-4528-b2ca-9600a5b1fd08)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [LinePropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LinePropertyList~_ctor.html) | Overloaded. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of LinePropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LinePropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. |
