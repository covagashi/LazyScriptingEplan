# ProtectedGroupPropertyList

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList.html

---

This class represents collection of properties of [ProtectedGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroup.html) class. Please check also base classes for other properties which are available for [ProtectedGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroup.html) objects: [PlacementPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlacementPropertyList.html), [StorableObjectPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObjectPropertyList.html)
...
               **Eplan.EplApi.DataModel.ProtectedGroupPropertyList**
...
public class ProtectedGroupPropertyList : GroupPropertyList
```
```
...
public ref class ProtectedGroupPropertyList : public GroupPropertyList
```
```
...
- [C#](#i-tab-content-f170c990-8c76-49c5-b574-f3f8f5d30c99)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ProtectedGroupPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList~_ctor.html) | Overloaded. |
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [DMPROTECTEDGROUP\_PARTNR](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList~DMPROTECTEDGROUP_PARTNR().html) | Protected group: Part number # 36700. |
...
| Public Property | [MACROBOX\_MACRO](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList~MACROBOX_MACRO().html) | Macro: File name # 23001. |
| Public Property | [MACROBOX\_NAME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList~MACROBOX_NAME().html) | Macro: Name # 23009. |
| Public Property | [MACROBOX\_REPRESENTATION\_TYPE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList~MACROBOX_REPRESENTATION_TYPE().html) | Macro: Representation type # 23007. |
| Public Property | [MACROBOX\_VARIANT](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList~MACROBOX_VARIANT().html) | Macro: Variant # 23008. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of ProtectedGroupPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. |
