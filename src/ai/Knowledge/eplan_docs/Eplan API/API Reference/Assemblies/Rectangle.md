...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle.html

---

This class represents a Rectangle on the [Eplan.EplApi.DataModel.Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html).
...
            **Eplan.EplApi.DataModel.Graphics.Rectangle**  
...
               [Eplan.EplApi.DataModel.Graphics.QRCode](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCode.html)
...
public class Rectangle : GraphicalPlacement

public ref class Rectangle : public GraphicalPlacement

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [Rectangle Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~_ctor().html) | Constructor. When object created with this constructor, its `create` method must be call. |
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [Angle](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~Angle.html) | Returns angle. |
| Public Property | [ChamferRadius](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~ChamferRadius.html) | Returns radius of Rectangle's corners chamfers. |
...
| Public Property | [FillPattern](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~FillPattern.html) | Gets or sets the fill pattern. Pattern types Bitmap, Eplan and System are not supported. |
...
| Public Property | [HasChamfers](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~HasChamfers.html) | Returns if the rectangle has chamfers. |
| Public Property | [Height](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~Height.html) | Returns height of the rectangle. |
...
| Public Property | [IsSurfaceFilled](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~IsSurfaceFilled.html) | This property specifies if the rectangle is filled. |
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~Location.html) | Overridden. Get or set the placement's location. |
| Public Property | [LowerLeftCorner](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~LowerLeftCorner.html) | Returns lower left corner's coordinates. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Rectangle~Properties.html) | .NET Property enabling access to P8 properties of the Rectangle object. |
