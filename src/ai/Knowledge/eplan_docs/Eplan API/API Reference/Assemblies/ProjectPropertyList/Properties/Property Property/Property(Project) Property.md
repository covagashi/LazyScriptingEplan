...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~Property(Project).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.Project id);

   void set (Properties.Project id, PropertyValue^ value);
