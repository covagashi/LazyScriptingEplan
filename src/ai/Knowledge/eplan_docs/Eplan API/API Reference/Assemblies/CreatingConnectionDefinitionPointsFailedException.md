...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.CreatingConnectionDefinitionPointsFailedException.html

---

Base class for printer exceptions but not abstract. It could throw when some undefined error occurred (e.g., HDC could not be created). Thrown when an error occurres while creating connection definition points.
