...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase.html

---

This class represents text displayed on the [Eplan.EplApi.DataModel.Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html).
...
            **Eplan.EplApi.DataModel.Graphics.TextBase**  
...
public class TextBase : GraphicalPlacement

public ref class TextBase : public GraphicalPlacement

Public Properties

|  | Name | Description |
| --- | --- | --- |
| Public Property | [AlignmentBoxFixedHeight](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~AlignmentBoxFixedHeight.html) | Specifies that height is fixed. |
| Public Property | [AlignmentBoxFixedWidth](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~AlignmentBoxFixedWidth.html) | Specifies that width is fixed. |
| Public Property | [AlignmentBoxHeight](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~AlignmentBoxHeight.html) | Specifies the height of alignment box. |
| Public Property | [AlignmentBoxNeverHyphenateWords](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~AlignmentBoxNeverHyphenateWords.html) | Specifies that words are wrapped. |
| Public Property | [AlignmentBoxRemoveBreaks](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~AlignmentBoxRemoveBreaks.html) | Specifies that breaks are removed. |
| Public Property | [AlignmentBoxTextFittingPermitted](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~AlignmentBoxTextFittingPermitted.html) | Gets/Sets a value that indicates whether the text fitting in Alignement Box is permitted or not. |
| Public Property | [AlignmentBoxWidth](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~AlignmentBoxWidth.html) | Specifies the width of alignment box. |
| Public Property | [Contents](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~Contents.html) | Contents of object represented by this type. |
...
| Public Property | [DockingDirection](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~DockingDirection.html) | Specifies docking direction for text. |
| Public Property | [DrawAlignmentBox](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~DrawAlignmentBox.html) | Returns the alignment box type |
...
| Public Property | [DrawTextBoxType](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~DrawTextBoxType.html) | Returns the text box type |
| Public Property | [FixedLanguage](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~FixedLanguage.html) | Specifies language for text when property LanguageMode value is set to LangModeFix. |
| Public Property | [Font](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~Font.html) | Font for displayed text. |
...
| Public Property | [HasBox](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~HasBox.html) | Returns true if the Text has an alignment box. In GUI it's 'Activate alignment box' checkbox. |
| Public Property | [Height](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~Height.html) | Returns height of the Text. |
| Public Property | [IsAutomaticallyTranslated](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~IsAutomaticallyTranslated.html) | Gets/sets the flag which corresponds to "Do not translate automatically" checkbox in GUI. |
| Public Property | [IsDocked](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~IsDocked.html) | Gets/Sets a value that indicates whether the text is docked or not. Setting IsDocked to true is possible only on PropertyPlacement object which Parent is a SymbolReference object. |
| Public Property | [IsLeaderLineActivated](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~IsLeaderLineActivated.html) | Returns true if the leader line is activated |
...
| Public Property | [Justification](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~Justification.html) | Returns the justification of the Text. |
| Public Property | [LanguageMode](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~LanguageMode.html) | Specifies language mode of text. |
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~Location.html) | Overridden. Get or set the placement's location. |
...
| Public Property | [ParagraphSpacing](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~ParagraphSpacing.html) | Specifies the Paragraph Spacing. This property is used for PropertyPlacemets attributes. |
| Public Property | [ParserParameter](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~ParserParameter.html) | Set / Get Parameters of the text |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~Properties.html) | .NET Property enabling access to P8 properties of the TextBase object. |
| Public Property | [Rotation](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~Rotation.html) | Returns the rotation of the Text, in radians. |
| Public Property | [RowSpacing](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~RowSpacing.html) | Specifies the Row Spacing. This property is used for PropertyPlacemets attributes. From layer: -16002, Single: 100, 1.5 lines: 150, Double: 200. |
| Public Property | [TextColorId](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~TextColorId.html) | Color for displayed text. Color index (0-255) Please use -16002 as "From layer" value. Predefined values for line color index are:  0 = black  1 = red  2 = yellow  3 = green  4 = cyan  5 = blue  6 = magenta  7 = white  252 = darkgray  253 = gray |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of TextBase object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
| Public Method | [DockText](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~DockText.html) | Docks one text to another. You can see how it works in GUI. Select element on schematic, display properties, show property placements and dock / undock them. |
...
| Public Method | [GetDisplayString](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~GetDisplayString.html) | Returns formated display string of the content |
...
| Public Method | [UndockText](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextBase~UndockText.html) | Undock text from another oner one. You can see how it works in GUI. Select element on schematic, display properties, show property placements and dock / undock them. |
