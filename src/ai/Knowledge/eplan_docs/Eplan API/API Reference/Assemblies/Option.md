...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option.html

---

Option class represents project's options.
...
public ref class Option : public OptionBase

Public Properties

|  | Name | Description |
| --- | --- | --- |
| Public Property | [Active](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option~Active.html) | State of the Option. |
...
| Public Property | [Group](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option~Group.html) | [OptionGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroup.html) of an Option. |
| Public Property | [HasGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option~HasGroup.html) | Determines if Option is in [OptionGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionGroup.html). |
...
| Public Property | [IsTransparent](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option~IsTransparent.html) | The 'Transparent' flag of the Option. |
...
| Public Property | [OptionFragments](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option~OptionFragments.html) | Returns all Eplan.EplApi.DataModel.OptionFragment contained in the option. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option~Properties.html) | .NET Property enabling access to P8 properties of the Option. |
...
|  | Name | Description |
| --- | --- | --- |
| Public Method | [AddOptionFragment](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option~AddOptionFragment.html) | adds a fragment to the option. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of Option object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
...
| Public Method | [Remove](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option~Remove.html) | Removes the Option. |
