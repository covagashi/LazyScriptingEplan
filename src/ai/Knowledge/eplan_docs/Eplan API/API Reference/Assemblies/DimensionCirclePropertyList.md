...
               **Eplan.EplApi.DataModel.Graphics.DimensionCirclePropertyList**
...
public class DimensionCirclePropertyList : GraphicalPlacementPropertyList
```
```
...
public ref class DimensionCirclePropertyList : public GraphicalPlacementPropertyList
```
```
...
- [C#](#i-tab-content-163afb75-8640-43c3-923e-975844d9eefe)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [DimensionCirclePropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCirclePropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [INSTANCE\_SIZE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCirclePropertyList~INSTANCE_SIZE().html) | Font size # 19017. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCirclePropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of DimensionCirclePropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCirclePropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. |
