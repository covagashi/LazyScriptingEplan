...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment~Create.html
...
| --- | --- |
| [Create(Project,SymbolReference,SymbolReference,Boolean)](topic1291.html) | Creates new unplaced segment and assign to it start and end symbol. |
