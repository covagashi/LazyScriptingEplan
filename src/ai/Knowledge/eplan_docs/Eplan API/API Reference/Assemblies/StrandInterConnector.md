...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandInterConnector.html

---

This class represents a strand inter connector object. This is kind of a bundle connection point.
...
            **Eplan.EplApi.DataModel.StrandInterConnector**
...
```
```
public class StrandInterConnector : SymbolReference, IPropertyPlacementsContainer
```
```

```
```
public ref class StrandInterConnector : public SymbolReference, IPropertyPlacementsContainer
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [StrandInterConnector Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandInterConnector~_ctor().html) | Default constructor. Should never be used. Always throws NotImplementedException. It was designed only for COM compatibility. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandInterConnector~Properties.html) | .NET Property enabling access to P8 properties of the StrandInterConnector object. |
