# UpgradePartsDb(String,String) Method

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsManagement~UpgradePartsDb(String,String).html
...
*strNewDatabaseName*
:   New database name. Full path to .alk database or connection string to SQL database.
