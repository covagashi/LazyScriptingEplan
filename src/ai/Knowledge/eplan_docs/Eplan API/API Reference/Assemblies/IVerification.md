...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.IVerification.html

---

Interface declaration for an electrotechnical check in EPLAN. If an add-in wants to add an undefined check to EPLAN projects this interface must be implemented by a class of the add-in.
...
| Method | [Execute](Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.IVerification~Execute.html) | Called by EPLAN when a specific object is to be checked. Implements the "check." |
