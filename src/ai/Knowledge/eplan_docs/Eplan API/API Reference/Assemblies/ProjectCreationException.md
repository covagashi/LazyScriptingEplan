...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectCreationException.html

---

Throw when Project cannot be created
...
public class ProjectCreationException : DataModelException

public ref class ProjectCreationException : public DataModelException

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ProjectCreationException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectCreationException~_ctor.html) | Overloaded. |
