...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition.html

---

Class represents a segment definition from PrePlanning project.
...
public class SegmentDefinition : Eplan.EplApi.DataModel.StorableObject, Eplan.EplApi.DataModel.IWriteProtection

public ref class SegmentDefinition : public Eplan.EplApi.DataModel.StorableObject, Eplan.EplApi.DataModel.IWriteProtection

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [SegmentDefinition Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~_ctor().html) | Default constructor. |
...
| Public Property | [DisplayedName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~DisplayedName.html) | Name under which the segment definition will be displayed in the project. |
| Public Property | [IdentifyingName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~IdentifyingName.html) | Unique name that was specified when the segment definition was created. |
| Public Property | [Image](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~Image.html) | Name of icon displayed in tree view of the pre-planning navigator for this definition. |
...
| Public Property | [IsNotUsedAnymore](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~IsNotUsedAnymore.html) | Determines whether the segment definition in the project is write-protected. |
...
| Public Property | [Parent](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~Parent.html) | Parent of this segment definition. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~Properties.html) | EPLAN properties of the SegmentDefinition object. |
| Public Property | [PropertiesConfigurations](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~PropertiesConfigurations.html) | Property configurations assigned to this segment definition. |
...
|  | Name | Description |
| --- | --- | --- |
| Public Method | [AddPropertyConfiguration](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~AddPropertyConfiguration.html) | Adds new property configuration for given user defined property definition. |
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~Create.html) | Creates SegmentDefinition object. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of SegmentDefinition object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
...
| Public Method | [GetWriteProtectionFlagSet](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~GetWriteProtectionFlagSet.html) | Checks if a specific write protection kind was set. |
...
| Public Method | [PauseWriteProtection](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~PauseWriteProtection.html) | Temporarily disables write protection. Note that current write protection flags are not cleared. |
| Public Method | [RemovePropertiesConfigurations](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentDefinition~RemovePropertiesConfigurations.html) | Removes all property configuration from segment definition. |
