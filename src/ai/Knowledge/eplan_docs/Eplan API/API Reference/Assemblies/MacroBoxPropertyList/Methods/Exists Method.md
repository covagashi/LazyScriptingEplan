...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroBoxPropertyList~Exists.html
...
| --- | --- |
| [Exists(MacroBox)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroBoxPropertyList~Exists(MacroBox).html) | Checks property existence for used obiect. |
