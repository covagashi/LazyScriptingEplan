...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_ERPNR_5().html
...
```
```
public MDPropertyValue ARTICLE_ERPNR_5 {get; set;}
```
```
...
property MDPropertyValue^ ARTICLE_ERPNR_5 {
