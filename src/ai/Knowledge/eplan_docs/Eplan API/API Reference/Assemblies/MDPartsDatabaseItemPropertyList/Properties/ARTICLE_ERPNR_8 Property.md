...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_ERPNR_8().html
...
public MDPropertyValue ARTICLE_ERPNR_8 {get; set;}

public:

property MDPropertyValue^ ARTICLE_ERPNR_8 {
