...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingPointMate.html

---

Represents a mounting point mate.
...
public class MountingPointMate : PointMate

public ref class MountingPointMate : public PointMate

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [MountingPointMate Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingPointMate~_ctor().html) | Default constructor. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingPointMate~Create.html) | Creates a mounting point mate. |
