...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.Baseu~Eplan.EplApi.Base.BaseException_properties.html

---

For a list of all members of this type, see [BaseException members](Eplan.EplApi.Baseu~Eplan.EplApi.Base.BaseException_members.html).
