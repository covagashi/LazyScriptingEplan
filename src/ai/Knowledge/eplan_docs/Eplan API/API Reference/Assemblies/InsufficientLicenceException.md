...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InsufficientLicenceException.html

---

Throw when the the number of logical pages in the project is equal or greater the max number of logical pages determined by license kind and the user want to add another logical page.
...
public class InsufficientLicenceException : DataModelException

public ref class InsufficientLicenceException : public DataModelException

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [InsufficientLicenceException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InsufficientLicenceException~_ctor.html) | Overloaded. |
