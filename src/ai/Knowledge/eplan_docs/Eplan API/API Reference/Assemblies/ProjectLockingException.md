...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectLockingException.html

---

Throw when Project cannot be locked
...
```
```
public class ProjectLockingException : DataModelException
```
```

```
```
public ref class ProjectLockingException : public DataModelException
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ProjectLockingException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectLockingException~_ctor.html) | Overloaded. |
