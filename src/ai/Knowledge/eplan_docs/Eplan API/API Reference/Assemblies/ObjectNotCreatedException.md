...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ObjectNotCreatedException.html

---

Throw when DataModel object is used, but has not been created yet.
...
                  **Eplan.EplApi.DataModel.ObjectNotCreatedException**
...
public class ObjectNotCreatedException : ObjectCreationException

public ref class ObjectNotCreatedException : public ObjectCreationException

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ObjectNotCreatedException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ObjectNotCreatedException~_ctor.html) | Overloaded. |
