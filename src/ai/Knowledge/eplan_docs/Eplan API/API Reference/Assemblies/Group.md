...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group.html

---

This class represents grouped [Placement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Placement.html)s.
...
            [Eplan.EplApi.DataModel.ProtectedGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroup.html)  
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~Location.html) | Overridden. Get or set the placement's location. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~Properties.html) | .NET Property enabling access to P8 properties of the Group object. |
| Public Property | [SubPlacements](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~SubPlacements.html) | Returns all grouped [Placement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Placement.html)s. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~Create.html) | Creates a new Group object. It is placed on the page of first placement given as parameter. |
| Public Method | [DeepUnGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~DeepUnGroup.html) | Overloaded. Remove all [Placement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Placement.html)s only from a group and it's sub groups. If true method will remove also SubGroups. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of Group object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
...
| Public Method | [GetBoundingBox](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~GetBoundingBox.html) | Overridden. Placement bounding box. Bounding box is a rectangle which contain this placement. It can be also used to determine placement size. |
...
| Public Method | [InsertSubPlacement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~InsertSubPlacement.html) | Insert [Placement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Placement.html) to a group. |
| Public Method | [InsertSubPlacements](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~InsertSubPlacements.html) | Insert [Placement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Placement.html)s to a group. |
| Public Method | [IsEditable](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~IsEditable.html) | Check if the Group is editable. |
| Public Method | [IsGroupValid](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~IsGroupValid.html) | Returns true, if group is valid if not, the group should be dissolved |
...
| Public Method | [Move](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~Move.html) | Moves the group |
| Public Method | [Remove](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~Remove.html) | Overridden. Removes placement. |
| Public Method | [RemoveSubPlacement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~RemoveSubPlacement.html) | Overloaded. Remove [Placement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Placement.html) from the group and from the project. The Placement object passed into this method is no longer valid. |
...
| Public Method | [UnGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~UnGroup.html) | Overloaded. Remove [Placement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Placement.html)s only from a group. |
