...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfo_methods.html

---

For a list of all members of this type, see [ConnectionPointsInfo members](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfo_members.html).
...
| Public Method | [Remove](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfo~Remove.html) | Removes the connection points info from the [Project](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Project.html). |
