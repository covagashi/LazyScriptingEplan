...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Restore_methods.html

---

For a list of all members of this type, see [Restore members](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Restore_members.html).
