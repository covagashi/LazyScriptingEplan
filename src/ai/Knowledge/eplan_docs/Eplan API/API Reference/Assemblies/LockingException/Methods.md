...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.Baseu~Eplan.EplApi.Base.LockingException_methods.html

---

For a list of all members of this type, see [LockingException members](Eplan.EplApi.Baseu~Eplan.EplApi.Base.LockingException_members.html).
