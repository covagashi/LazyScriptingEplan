...
               **Eplan.EplApi.DataModel.Graphics.DimensionItemPropertyList**
...
public class DimensionItemPropertyList : GraphicalPlacementPropertyList
```
```
...
public ref class DimensionItemPropertyList : public GraphicalPlacementPropertyList
```
```
...
- [C#](#i-tab-content-3fb1820b-ff76-4d68-9d91-fc0e5df134a3)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [DimensionItemPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionItemPropertyList~_ctor.html) | Overloaded. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of DimensionItemPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionItemPropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. |
