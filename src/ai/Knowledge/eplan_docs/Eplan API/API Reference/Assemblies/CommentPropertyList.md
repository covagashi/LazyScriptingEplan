...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.CommentPropertyList.html
...
- [C#](#i-tab-content-0bfe7675-ffa6-4dc0-b485-0d9f7752c8e8)
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [DMG\_COMMENT\_RESPONSE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.CommentPropertyList~DMG_COMMENT_RESPONSE(Int32).html) | Reply text # 19504. |
| Public Property | [DMG\_COMMENT\_RESPONSE\_AUTHOR](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.CommentPropertyList~DMG_COMMENT_RESPONSE_AUTHOR(Int32).html) | Author: Reply # 19503. |
| Public Property | [DMG\_COMMENT\_RESPONSE\_DATETIME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.CommentPropertyList~DMG_COMMENT_RESPONSE_DATETIME(Int32).html) | Date and time # 19505. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.CommentPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties. |
...
| Public Method | [Exists](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.CommentPropertyList~Exists.html) | Overloaded. Checks property existence for used obiect. |
