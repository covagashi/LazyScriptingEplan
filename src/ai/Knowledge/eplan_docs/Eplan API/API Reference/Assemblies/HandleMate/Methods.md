...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.HandleMate_methods.html

---

For a list of all members of this type, see [HandleMate members](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.HandleMate_members.html).
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.HandleMate~Create.html) | Overloaded. Creates a handle mate from existing mate |
