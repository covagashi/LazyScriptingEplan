...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image.html
...
               **Eplan.EplApi.DataModel.Graphics.Image**
...
| Public Property | [FileName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image~FileName.html) | Full file name of the image file. |
| Public Property | [FillPattern](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image~FillPattern.html) | Overridden. Gets or sets the fill pattern. Pattern types Bitmap, Eplan and System are not supported. |
...
| Public Property | [IsSurfaceFilled](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image~IsSurfaceFilled.html) | Overridden. This property specifies if the rectangle is filled. |
...
| Public Property | [PhysicalDimension](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image~PhysicalDimension.html) | Returns size of the bitmap in points. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image~Properties.html) | .NET Property enabling access to P8 properties of the Image object. |
