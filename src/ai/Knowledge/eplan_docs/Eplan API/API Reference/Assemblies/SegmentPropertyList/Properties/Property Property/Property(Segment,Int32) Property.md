# Property(Segment,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.SegmentPropertyList~Property(Segment,Int32).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.Segment id, int index);

   void set (Properties.Segment id, int index, PropertyValue^ value);
...
*index*
:   Index of the Segment's property
