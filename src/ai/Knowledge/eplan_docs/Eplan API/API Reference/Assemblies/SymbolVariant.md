...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant.html

---

This class represents a symbol from a symbol library of a given project.
...
```
```
public ref class SymbolVariant : public Eplan.EplApi.DataModel.Group, Eplan.EplApi.DataModel.IPlacementsContainer, Eplan.EplApi.DataModel.IPropertyPlacementsContainer
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [ConnectionPoints](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~ConnectionPoints.html) | An array of symbol's connection points |
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~Location.html) | Overridden. Get or set the placement's location. |
...
| Public Property | [Parent](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~Parent.html) | Returns symbol, for which this variant was created. |
| Public Property | [Project](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~Project.html) | Overridden. Returns the project to which the StorableObject belongs. |
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~Properties.html) | Allows access to properties of the SymbolVariant |
| Public Property | [PropertyPlacements](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~PropertyPlacements.html) | Returns [Eplan.EplApi.DataModel.Graphics.PropertyPlacement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PropertyPlacement.html)s assigned to the SymbolVariant. |
...
| Public Property | [SymbolLibraryName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~SymbolLibraryName.html) | Returns name of the library the symbol is taken from. |
| Public Property | [SymbolName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~SymbolName.html) | Returns number of the symbol in the library (unique for library) assigned to the SymbolVariant. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~Create.html) | Overloaded. Creates object on page from information contained in SymbolVariant object. |
...
| Public Method | [Initialize](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolVariant~Initialize.html) | Initializes the SymbolVariant object. |
