...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ReportBlockReference.html

---

ReportBlockReference class represents P8's dynamic formulars and embedded reports.
...
            **Eplan.EplApi.DataModel.ReportBlockReference**
...
public class ReportBlockReference : Group, IPlacementsContainer

public ref class ReportBlockReference : public Group, IPlacementsContainer

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ReportBlockReference Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ReportBlockReference~_ctor().html) | Default constructor. |
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ReportBlockReference~Location.html) | Overridden. Get or set the placement's location. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ReportBlockReference~Properties.html) | .NET Property enabling access to P8 properties of the ReportBlockReference object. |
| Public Property | [ReportBlock](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ReportBlockReference~ReportBlock.html) | `ReportBlock` associated with this `ReportBlockReference`. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~Create.html) | Creates a new Group object. It is placed on the page of first placement given as parameter. (Inherited from [Eplan.EplApi.DataModel.Group](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group.html)) |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of ReportBlockReference object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
