...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem.html

---

Represents bus bar system object in 3d space
...
            **Eplan.EplApi.DataModel.E3D.BusBarSystem**
...
Corresponding FunctionCategory for this class is CabVirtBusbarsystem.
...
oBusBarSystem.Create(m_oTestProject, "RIT.RiLine100_3_40x10", "1", 3, 50.0);
...
Console.WriteLine(holders.Length);
```
...
| Public Property | [BarCount](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem~BarCount.html) | number of busbars. |
| Public Property | [BarDistance](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem~BarDistance.html) | distance between busbars. |
| Public Property | [BarToMountingPlateDistance](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem~BarToMountingPlateDistance.html) | distance from MountingPlate to busbars. |
| Public Property | [BaseMate](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem~BaseMate.html) | Returns default target mate used to place bus bar which will be located on the top in bus bar system. |
| Public Property | [BusBars](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem~BusBars.html) | Returns all associated busbar objects. |
...
| Public Property | [Holder](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem~Holder.html) | Returns all associated holders objects. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem~Properties.html) | .NET Property enabling access to P8 properties of the BusBarSystem object. |
...
| Public Methodstatic (Shared in Visual Basic) | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem~Create.html) | Overloaded. Creates not placed Busbar system. |
| Public Methodstatic (Shared in Visual Basic) | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem~CreateTransient.html) | Creates not placed transient Busbar system. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of BusBarSystem object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
