...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint.html

---

Represents net definition point object.
...
               **Eplan.EplApi.DataModel.NetDefinitionPoint**
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [AdditionalConnections](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint~AdditionalConnections.html) | .NET Property enabling access to additional connections of the net not stored at this NetDefinitionPoint |
...
| Public Property | [Connections](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint~Connections.html) | .NET Property enabling access to NetDefinitionPoint connections |
...
| Public Property | [DaisyChains](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint~DaisyChains.html) | Returns daisy chains of a net definition point |
...
| Public Property | [NetConnectionPoints](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint~NetConnectionPoints.html) | Returns all PinBase objects of NetDefinitionPoint |
...
| Public Property | [PotentialName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PotentialDefinition~PotentialName.html) | Gets/Sets the name of the potential. (Inherited from [Eplan.EplApi.DataModel.PotentialDefinition](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PotentialDefinition.html)) |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint~Properties.html) | .NET Property enabling access to P8 properties of the NetDefinitionPoint object. |
...
| Public Property | [SignalName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PotentialDefinition~SignalName.html) | Gets/Sets the name of the signal. (Inherited from [Eplan.EplApi.DataModel.PotentialDefinition](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PotentialDefinition.html)) |
...
|  | Name | Description |
| --- | --- | --- |
| Public Method | [AddDaisyChain](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint~AddDaisyChain(NetConnectionPoint[]).html) | Creates new DaisyChain object |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of NetDefinitionPoint object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
...
| Public Method | [RemoveConnections](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint~RemoveConnections.html) | Remove connections of NetDefinitionPoint object |
| Public Method | [RemoveDaisyChain](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint~RemoveDaisyChain.html) | Removes daisy chain from a net definition point |
