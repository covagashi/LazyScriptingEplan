...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PagePropertyList~Exists.html
...
| --- | --- |
| [Exists(Page)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PagePropertyList~Exists(Page).html) | Checks property existence for used obiect. |
