...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionDefinitionPropertyList.html

---

This class represents collection of properties of [FunctionDefinition](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionDefinition.html) class. Please check also base classes for other properties which are available for [FunctionDefinition](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionDefinition.html) objects: [StorableObjectPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObjectPropertyList.html)
...
         **Eplan.EplApi.DataModel.FunctionDefinitionPropertyList**
...
public class FunctionDefinitionPropertyList : StorableObjectPropertyList
```
```
...
public ref class FunctionDefinitionPropertyList : public StorableObjectPropertyList
```
```
...
- [C#](#i-tab-content-f5397ac7-c0a5-4b4e-ae67-d710d9c95afd)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [FunctionDefinitionPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionDefinitionPropertyList~_ctor.html) | Overloaded. |
