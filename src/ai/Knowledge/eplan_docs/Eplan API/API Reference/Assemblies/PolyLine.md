...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine.html

---

This class represent PolyLine on the [Eplan.EplApi.DataModel.Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html). The following example shows how to use class PolyLine.
...
            **Eplan.EplApi.DataModel.Graphics.PolyLine**  
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [Closed](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~Closed.html) | True, if the poly line is closed. |
...
| Public Property | [FillPattern](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~FillPattern.html) | Gets or sets the fill pattern of the PolyLine. Pattern types Bitmap, Eplan and System are not supported. |
...
| Public Property | [IsSurfaceFilled](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~IsSurfaceFilled.html) | This property specifies if the polyline is filled. When the polyline is not closed setting this property throws an exception |
...
| Public Property | [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~Location.html) | Overridden. Get or set the placement's location. |
| Public Property | [NumberOfPoints](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~NumberOfPoints.html) | Number of vertices of a poly line. |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~Properties.html) | .NET Property enabling access to P8 properties of the PolyLine object. |
...
| Public Methodstatic (Shared in Visual Basic) | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~Create.html) | Overloaded. Creates a PolyLine object. |
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~CreateTransient.html) | Overridden. Creates transient and not placed PolyLine object. |
...
| Public Method | [GetBulgeAt](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~GetBulgeAt.html) | Returns the corner arc of one vertex of a poly line |
...
| Public Method | [GetPointAt](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~GetPointAt.html) | Returns the coordinates of a vertex of a polyline |
...
| Public Method | [SetBulgeAt](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~SetBulgeAt.html) | Sets the corner arc of one vertex of a poly line |
| Public Method | [SetPointAt](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PolyLine~SetPointAt.html) | Sets one vertex of a polyline If the index of this point does not yet exist it will be added. |
