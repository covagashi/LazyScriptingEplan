# Property(ProtectedGroup) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProtectedGroupPropertyList~Property(ProtectedGroup).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.ProtectedGroup id);

   void set (Properties.ProtectedGroup id, PropertyValue^ value);
