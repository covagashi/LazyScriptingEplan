...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PathTextPropertyList~Exists.html
...
| --- | --- |
| [Exists(PathText)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PathTextPropertyList~Exists(PathText).html) | Checks property existence for used obiect. |
| [Exists(Text)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextPropertyList~Exists(Text).html) | Checks property existence for used obiect. (Inherited from [Eplan.EplApi.DataModel.Graphics.TextPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextPropertyList.html)) |
