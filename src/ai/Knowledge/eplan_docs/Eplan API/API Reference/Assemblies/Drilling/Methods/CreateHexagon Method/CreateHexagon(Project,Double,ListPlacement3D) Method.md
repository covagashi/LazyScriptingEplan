...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Drilling~CreateHexagon(Project,Double,List{Placement3D}).html
...
public static Drilling CreateHexagon( 
