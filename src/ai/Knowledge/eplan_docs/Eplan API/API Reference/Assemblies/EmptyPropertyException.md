...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.EmptyPropertyException.html

---

Throw when property is empty and couldn't return logic value; It could be prevented by checking PropertyValue::Empty.
...
public class EmptyPropertyException : DataModelException

public ref class EmptyPropertyException : public DataModelException

Public Constructors

|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [EmptyPropertyException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.EmptyPropertyException~_ctor.html) | Overloaded. |
