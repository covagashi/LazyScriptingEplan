...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.WrongSegmentDefinitionException.html

---

Throw when there is an error related to a segment definition of planning object.
