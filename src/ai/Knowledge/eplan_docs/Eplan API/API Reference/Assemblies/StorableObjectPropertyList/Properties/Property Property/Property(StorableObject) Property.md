# Property(StorableObject) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObjectPropertyList~Property(StorableObject).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.StorableObject id);

   void set (Properties.StorableObject id, PropertyValue^ value);
