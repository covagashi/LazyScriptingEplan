...
                     **Eplan.EplApi.DataModel.ContextPropertyPlacementPropertyList**  
...
public class ContextPropertyPlacementPropertyList : Eplan.EplApi.DataModel.Graphics.PropertyPlacementPropertyList
```
```
...
public ref class ContextPropertyPlacementPropertyList : public Eplan.EplApi.DataModel.Graphics.PropertyPlacementPropertyList
```
```
...
- [C#](#i-tab-content-316c7ee0-eb52-44cc-bcba-612ea9e2af57)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [ContextPropertyPlacementPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ContextPropertyPlacementPropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ContextPropertyPlacementPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties by AnyPropertyId. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of ContextPropertyPlacementPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
