...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PropertyAlreadyExistsException.html

---

Throw when property already exists.
...
               **Eplan.EplApi.DataModel.PropertyAlreadyExistsException**
...
```
```
public class PropertyAlreadyExistsException : InvalidArgumentException
```
```

```
```
public ref class PropertyAlreadyExistsException : public InvalidArgumentException
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [PropertyAlreadyExistsException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PropertyAlreadyExistsException~_ctor.html) | Overloaded. |
