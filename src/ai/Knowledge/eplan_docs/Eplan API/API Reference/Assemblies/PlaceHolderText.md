...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderText.html

---

This class represents placeholder text displayed on the [Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html).
...
                  **Eplan.EplApi.DataModel.PlaceHolderText**
...
|  | Name | Description |
| --- | --- | --- |
| Public Property | [ActionName](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderText~ActionName.html) | Gets/Sets the action name. |
...
| Public Property | [Contents](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Text~Contents.html) | Contents of object represented by this type. (Inherited from [Eplan.EplApi.DataModel.Graphics.Text](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Text.html)) |
...
| Public Property | [GroupType](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderText~GroupType.html) | Group type |
...
| Public Property | [PlaceHolderType](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderText~PlaceHolderType.html) | Placeholder type |
...
| Public Property | [PropDescr](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderText~PropDescr.html) | Property Id and index |
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderText~Properties.html) | .NET Property enabling access to P8 properties of the PlaceHolderTextPropertyList object. |
| Public Property | [Relation](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderText~Relation.html) | Returns relation id and index encapsulated by Relation class. |
...
| Public Property | [SourceObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderText~SourceObject.html) | Gets an object from which a PlaceHolderText was created. |
