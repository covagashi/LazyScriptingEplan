...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment.html
...
To create valid topology all elements to which segment is connected have to be have their representation type set to [Eplan.EplApi.DataModel.DocumentTypeManager.DocumentType.Topology](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DocumentTypeManager+DocumentType.html).
...
| Public Property | [EndPoint](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment~EndPoint.html) | Returns end point of this segment. |
| Public Property | [EndSymbolReference](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment~EndSymbolReference.html) | Returns the second of two [Eplan.EplApi.DataModel.SymbolReference](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.SymbolReference.html)s connected by this segment. |
| Public Property | [FunctionCategory](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function~FunctionCategory.html) | Returns the category of a Function. (Inherited from [Eplan.EplApi.DataModel.Function](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function.html)) |
...
| Public Property | [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment~Properties.html) | .NET Property enabling access to EPLAN properties of the Segment object. |
...
| Public Property | [StartPoint](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment~StartPoint.html) | Returns start point of this segment. |
| Public Property | [StartSymbolReference](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment~StartSymbolReference.html) | Returns the first of two [Eplan.EplApi.DataModel.SymbolReference](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.SymbolReference.html)s connected by this segment. |
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment~Create.html) | Overloaded. Creates new unplaced segment and assign to it start and end symbol. |
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment~CreateTransient.html) | Overloaded. Creates new transient unplaced segment and assign to it start and end symbol. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of Segment object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
