...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionFragmentPropertyList~Exists.html
...
| --- | --- |
| [Exists(OptionFragment)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionFragmentPropertyList~Exists(OptionFragment).html) | Checks property existence for used obiect. |
