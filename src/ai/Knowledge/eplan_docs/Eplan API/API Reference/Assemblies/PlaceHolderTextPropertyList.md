...
                     **Eplan.EplApi.DataModel.PlaceHolderTextPropertyList**
...
public class PlaceHolderTextPropertyList : Eplan.EplApi.DataModel.Graphics.TextPropertyList
```
```
...
public ref class PlaceHolderTextPropertyList : public Eplan.EplApi.DataModel.Graphics.TextPropertyList
```
```
...
- [C#](#i-tab-content-b46dbedd-e613-4f2c-8d1f-851912cc3d33)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [PlaceHolderTextPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderTextPropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [Property](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlaceHolderTextPropertyList~Property.html) | Overloaded. Method used by operator[] in order to access indexed properties by AnyPropertyId. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of PlaceHolderTextPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
