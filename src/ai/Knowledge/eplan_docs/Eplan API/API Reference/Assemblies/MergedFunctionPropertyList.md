...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedFunctionPropertyList.html

---

This class represents collection of properties of [MergedFunction](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedFunction.html) class. Please check also base classes for other properties which are available for [MergedFunction](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedFunction.html) objects: [StorableObjectPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObjectPropertyList.html)
...
         **Eplan.EplApi.DataModel.MergedFunctionPropertyList**
...
public class MergedFunctionPropertyList : StorableObjectPropertyList
```
```
...
public ref class MergedFunctionPropertyList : public StorableObjectPropertyList
```
```
...
- [C#](#i-tab-content-741f9d5c-405b-494a-895b-ec818d9758c4)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [MergedFunctionPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedFunctionPropertyList~_ctor.html) | Overloaded. |
...
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList~Dispose().html) | Destructor for deterministic finalization of MergedFunctionPropertyList object. (Inherited from [Eplan.EplApi.DataModel.UniversalPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.UniversalPropertyList.html)) |
