# Property(Line,Int32) Property

**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LinePropertyList~Property(Line,Int32).html
...
property PropertyValue^ Property {
   ...
   PropertyValue^ get(Properties.Line id, int index);

   void set (Properties.Line id, int index, PropertyValue^ value);
