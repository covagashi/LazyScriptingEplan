...
**Source URL:** https://www.eplan.help/en-us/Infoportal/Content/api/2026/Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.IncorrectObjectTypeException.html

---

Thrown when create function is invoked with wrong object.
...
                  **Eplan.EplApi.DataModel.IncorrectObjectTypeException**
...
((Text)PathText).create( ... ); // Error, function Text::create() is invoked instead of PathText::create()
```
